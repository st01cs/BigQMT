...
EXPECTED_TOOLS = {
    "bsm_iv", "bsm_price", "get_account_status",
    "get_all_subscription", "get_assure_contract", "get_available_funds",
    "get_bar_timetag", "get_bvol", "get_close_price",
    ...
    "get_etf_iopv", "get_financial_data",
    ...
    "load_stk_vol_list", "subscribe_quote",
